...
testground run composition -f ${__dir}/../plans/_integrations_interop/_compositions/issue-1337-groups-builder-configuration-global-override.toml --collect --wait | tee stdout.out
